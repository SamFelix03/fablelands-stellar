...
The following diagram illustrates the complete user journey from minting an egg to reaching the adult stage, including all interactions, achievements, and evolution mechanics. Note that several processes depend on block-height (ledger sequence) rather than real-world time, as indicated by the ⛓️ symbol.
